...
public class MissionMapper {
    ...
    public Mission convertToEntityFromRequestDto(MissionRequestDto missionRequestDto) {
        ...
        mission.setRocketId(rocketService.getRocketById(missionRequestDto.getRocketId()).getId());
        mission.setCargoId(cargoService.getCargoById(missionRequestDto.getCargoId()).getId());
